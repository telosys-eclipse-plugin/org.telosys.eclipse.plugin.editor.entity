...
//	private final static String[] ANNOTATIONS_WITH_PARENTHESIS ; 
	private final static List<String>  ANNOTATIONS_WITH_PARENTHESIS = KeyWords.getAllAnnotationsWithPrefixAndParentheses(); // From DSL parser v 4.2
	
//	// ANNOTATIONS INITIALIZATION 
//	static {
//		// List<String> annotations = KeyWords.getAnnotations(); // From DSL parser
//		List<String> annotations = KeyWords.getAllAnnotationsWithPrefixAndParentheses(); // From DSL parser v 4.2
//		
...
//	public final static String[] getAnnotationsWithParenthesis() {
	public final static List<String> getAnnotationsWithParenthesis() {
